...
compass.tickSize = {w = 0.002, h = 0.01}

compass.cardinal.textSize = 0.4
compass.cardinal.textOffset = 0.02
compass.cardinal.textColour = {r = 255, g = 255, b = 255, a = 255}

compass.cardinal.tickShow = true
compass.cardinal.tickSize = {w = 0.003, h = 0.04}
...
compass.intercardinal.tickSize = {w = 0.002, h = 0.025}
...
TriggerEvent('chat:addSuggestion', '/compass', 'Toggle the compass on / off')
